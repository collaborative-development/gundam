...
let wrapper: RenderResult, wrapper2: RenderResult, menuElement: HTMLElement, acitveElement: HTMLElement, disabledElement: HTMLElement
describe('test Menu and MenuItem component', () => {
    ...
    it('should render corrent Menu and MenuItem based on default props', () => {
        ...
        expect(menuElement).toHaveClass('gundam-menu test')
        expect(menuElement.querySelectorAll(':scope > li').length).toEqual(5)
        expect(acitveElement).toHaveClass('menu-item is-active')
        expect(disabledElement).toHaveClass('menu-item is-disabled')
    })
    it('click items should change active and call the right callback', () => {
        const thirdItem = wrapper.getByText('cool link 2')
